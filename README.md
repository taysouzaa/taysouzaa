...
Atuo nas duas pontas do desenvolvimento: **frontend**, construindo interfaces modernas e responsivas com foco na experiência do usuário; e **backend**, com ênfase em automação, integração de sistemas e APIs. Gosto de ter visão do produto completo, do design ao banco de dados.
...
[![Backend](https://skillicons.dev/icons?i=nodejs,python,java)](https://skillicons.dev)

**Banco de Dados**

[![Database](https://skillicons.dev/icons?i=mysql,prisma,firebase,supabase)](https://skillicons.dev)

**Nuvem e DevOps**

[![DevOps](https://skillicons.dev/icons?i=gcp,docker,git,github)](https://skillicons.dev)
...
| Sistema | Descrição |
|---|---|
| **SPI — Sistema de Processamento de Imagens** | Plataforma web (React + Node.js + TypeScript) que automatiza o tratamento e padronização de imagens de produtos para marketplaces, com integração ao Google Drive |
| **P4 Calculator** | Ferramenta de cálculo e apoio operacional para processos internos da empresa |
...
|---|---|---|
| [ROE — Registro de Ocorrência Escolar](https://github.com/taysouzaa/Roe-Registro-Ocorrencia-Escolar) | Sistema web de TCC — gestão de ocorrências escolares | HTML · CSS · JS |
| [Gerador de Senhas](https://github.com/taysouzaa/Gerador-de-senhas-) | Geração de senhas seguras com opções personalizáveis | TypeScript |
| [MetaAssistente](https://github.com/taysouzaa/MetaAssistente) | Automações via API da Meta | JavaScript |
| [RotaLinks](https://github.com/taysouzaa/RotaLinks) | Landing page de links para redes sociais | HTML · CSS |
| [Receitopia](https://github.com/taysouzaa/Receitopia) | Site de receitas culinárias | HTML · CSS |
